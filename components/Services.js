...
const Services = () => {
    return (
        <div className="flex flex-col md:flex-row mx-auto justify-evenly max-w-6xl">
            <div className="flex mx-auto mb-2 p-8 flex-col max-w-xs bg-purple-300 rounded shadow-lg">
