        ...
        <>
            <div className='flex mt-10 justify-center w-full'>
                <div className='flex flex-col justify-center md:p-28 w-full p-10 md:w-1/2'>
                    <h1 className='w-full font-bold text-4xl lg:text-6xl animate-move-bg bg-gradient-to-r from-indigo-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent bg-[length:400%]'>B13Designs.com</h1>
